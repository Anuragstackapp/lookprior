...
GetBroadCastDetail getBroadCastDetailFromJson(String str) => GetBroadCastDetail.fromJson(json.decode(str));

String getBroadCastDetailToJson(GetBroadCastDetail data) => json.encode(data.toJson());

class GetBroadCastDetail {
  GetBroadCastDetail({
    this.success,
    this.message,
    this.broadCastId,
    ...
    this.isFavAd,
    this.currentUserId,
    this.hasVideoAndImageMissing,
    this.videoAndImageMissingErrorMessage,
    this.allowLeadGeneration,
    this.hasUnlimitedLead,
  ...
  factory GetBroadCastDetail.fromJson(Map<String, dynamic> json) => GetBroadCastDetail(
    ...
    adImage: List<AdImage>.from(json["AdImage"].map((x) => AdImage.fromJson(x))),
    adVideo: List<AdVideo>.from(json["AdVideo"].map((x) => AdVideo.fromJson(x))),
    similarAddList: List<SimilarAddList>.from(json["SimilarAddList"].map((x) => SimilarAddList.fromJson(x))),
    ...
    videoAndImageMissingErrorMessage: json["VideoAndImageMissingErrorMessage"],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "SimilarAddList": List<dynamic>.from(similarAddList!.map((x) => x.toJson())),
    "IsTopAd": isTopAd,
